...
window.__CLINIC_CONFIG = {
  ...
  // The user guide, hosted on the marketing site. The site is one deployment
  // shared by every clinic, so this is normally the same everywhere -- it lives
  // here rather than in index.html so it can be corrected without re-stamping
  // the CSP hash, which is the same reason the Firebase values are here.
  //
  // Set "" to hide the User Guide row in Settings entirely.
  guideUrl: "https://ginwalamurtaza66-hash.github.io/clinic-chart-site/guide/",
