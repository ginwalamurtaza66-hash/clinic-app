...
window.__CLINIC_CONFIG = {
  ...
  // guideUrl is NOT set here on purpose.
  //
  // The user guide lives on the marketing site, which is one deployment shared
  // by every clinic, so the address is the same everywhere and index.html
  // carries it as a constant. This file is for what DIFFERS between clinics.
  //
  // Uncomment only if this clinic hosts its own copy of the site. Setting it to
  // "" hides the User Guide row in Settings altogether.
  //   guideUrl: "https://your-own-site/guide/",
